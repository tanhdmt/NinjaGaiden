...
int			G_GameDepth;
const char*		G_GameName = "NinjaGaiden";
int			G_FrameRate = 60;
int			G_ColorMode;
...
int			G_ScreenHeight = 416; //480;	//480	//768	//768
...
{
	const char *_traceFile = "C:\\Temp\NG_game.log";
	int _traceNum = 1;
...
{
	MessageBox(G_hWnd, text, "NinjaGaiden", MB_OK);
}

void GLTitle(const char* text) {
